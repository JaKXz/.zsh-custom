# Generated by Powerlevel10k configuration wizard on 2020-12-26 at 14:25 EST.
...
() {
  ...
  prompt_node_version() {
    ...
    _p9k_prompt_segment "$0" "green" "white" 'NODE_ICON' 0 '' "${_p9k__ret#v} @npm:$(npm -v)"
  }

  prompt_ruby_version() {
    _p9k_prompt_segment "$0" "088" "$_p9k_color1" 'RUBY_ICON' 0 '' ${$(ruby --version)[2]}
  }
