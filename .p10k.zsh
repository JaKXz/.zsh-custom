# Generated by Powerlevel10k configuration wizard on 2022-06-27 at 13:47 CEST.
...
() {
  ...
  prompt_my_ruby_version() {
    local rubyv=$(ruby --version 2>&1 | awk '{print $2}')
    _p9k_prompt_segment "$0" "red" "$_p9k_color2" 'RUBY_ICON' 0 '' "$rubyv"
  }
